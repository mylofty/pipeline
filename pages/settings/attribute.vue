  ...
  <view class="attribute-container">
    ...
    <view class="content-area">
      ...
      <CollapseItem title="排水管点(PS)" :open="true">
        <AttributeGroup
          :attributes="drainagePointAttrs"
          @toggle="handleToggle('drainagePoint', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="排水管线(PS)">
        <AttributeGroup
          :attributes="drainageLineAttrs"
          @toggle="handleToggle('drainageLine', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="电力管点(DL)">
        <AttributeGroup
          :attributes="powerPointAttrs"
          @toggle="handleToggle('powerPoint', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="电力管线(DL)">
        <AttributeGroup
          :attributes="powerLineAttrs"
          @toggle="handleToggle('powerLine', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="通信管点(TX)">
        <AttributeGroup
          :attributes="telecomPointAttrs"
          @toggle="handleToggle('telecomPoint', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="通信管线(TX)">
        <AttributeGroup
          :attributes="telecomLineAttrs"
          @toggle="handleToggle('telecomLine', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="给水管点(JS)">
        <AttributeGroup
          :attributes="waterPointAttrs"
          @toggle="handleToggle('waterPoint', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="给水管线(JS)">
        <AttributeGroup
          :attributes="waterLineAttrs"
          @toggle="handleToggle('waterLine', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="燃气管点(RQ)">
        <AttributeGroup
          :attributes="gasPointAttrs"
          @toggle="handleToggle('gasPoint', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="燃气管线(RQ)">
        <AttributeGroup
          :attributes="gasLineAttrs"
          @toggle="handleToggle('gasLine', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="工业管点(GY)">
        <AttributeGroup
          :attributes="industrialPointAttrs"
          @toggle="handleToggle('industrialPoint', $event)"
        />
      </CollapseItem>
      ...
      <CollapseItem title="工业管线(GY)">
        <AttributeGroup
          :attributes="industrialLineAttrs"
          @toggle="handleToggle('industrialLine', $event)"
        />
      </CollapseItem>
    </view>
  </view>
